    ...
    return (
        <footer className="bg-gradient-to-r from-orange-500 to-orange-500 w-full text-white py-10">
            <div className="container mx-auto px-5 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div className="mt-4 space-y-2">
                        ...
                        <p className="flex items-center gap-2">
                            <Link href="https://yogawithakhu.vercel.app" target="_blank" crossOrigin="anonymous" rel="noopener noreferrer preload" className="flex items-center gap-2 hover:no-underline">
                ...
                <div>
                    ...
                    <ul className="mt-2 space-y-2">
                        <li>
                            <Link rel="preload" crossOrigin="anonymous" href="#home"
                                className="hover:no-underline cursor-pointer">Home
                            </Link>
                        </li>
                        <li>
                            <Link rel="preload" crossOrigin="anonymous" href="#about"
                                className="hover:no-underline cursor-pointer">About Us
                            </Link>
                        </li>
                        <li>
                            <Link rel="preload" crossOrigin="anonymous" href="#contact"
                ...
                <div>
                    ...
                    <ul className="mt-2 space-y-2">
                        <li>
                            <Link rel="preload" crossOrigin="anonymous" href="/#quality">
                                <span className="hover:no-underline cursor-pointer">Quality</span>
                            </Link>
                        </li>
                        <li>
                            <Link rel="preload" crossOrigin="anonymous" href="/#products">
            ...
            <div className="mt-10 border-t border-gray-700 pt-5 text-center text-white text-sm">
                ...
                <p className="mt-1">
                    Developed by{" "}
                    <Link rel="preload" crossOrigin="anonymous" href="https://Yuvraj_Singh" target="_blank">
